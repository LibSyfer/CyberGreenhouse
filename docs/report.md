...
- [Отчёт о выполнении задачи "Киберимунный сельскохозяйственный комплекс по выращиванию помидоров"](#отчёт-о-выполнении-задачи-name)
  ...
  - [Декомпозиция архитектуры](#декомпозиция-архитектуры)
    ...
    - [Базовый сценарий декомпозированной архитектуры](#базовый-сценарий-декомпозированной-архитектуры)
    - [Политика архитектуры](#политика-архитектуры)
    - [Качественные оценки доменов](#качественные-оценки-доменов)
    - [Обоснование уровня доверия модулей](#обоснование-уровня-доверия-модулей)
